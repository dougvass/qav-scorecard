...
export const SCORE_COL_META: ScoreColMeta[] = [
  ...
  { key: "S_pe_hi_lo",        label: "PE Hi/Lo",     description: "PE at historical low → 1pt (Phase 2)", phase: 2 },
  { key: "S_equity_inc",      label: "Equity Inc",   description: "Equity increasing trend → 1pt (Phase 2)", phase: 2 },
